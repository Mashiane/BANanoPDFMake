...
Object _item = null;
 //BA.debugLineNum = 49;BA.debugLine="Sub AddItems(lst As List)";
 //BA.debugLineNum = 50;BA.debugLine="For Each item As Object In lst";
{
...
_item = group1.Get(index1);
 //BA.debugLineNum = 51;BA.debugLine="items.Add(item)";
_items.Add(_item);
 }
};
...
public b4j.example.pdflist  _addtext(b4j.example.pdftext _txt) throws Exception{
 //BA.debugLineNum = 43;BA.debugLine="Sub AddText(txt As PDFText) As PDFList";
 //BA.debugLineNum = 44;BA.debugLine="items.Add(txt.Content)";
...
_style = new b4j.example.pdfstyle();
 //BA.debugLineNum = 7;BA.debugLine="Public reversed As Boolean";
_reversed = false;
 //BA.debugLineNum = 8;BA.debugLine="Public start As Int";
_start = 0;
 //BA.debugLineNum = 9;BA.debugLine="Public square As Boolean";
_square = false;
 //BA.debugLineNum = 10;BA.debugLine="Public circle As Boolean";
_circle = false;
 //BA.debugLineNum = 11;BA.debugLine="Public color As String";
_color = "";
 //BA.debugLineNum = 12;BA.debugLine="Public markerColor As String";
_markercolor = "";
 //BA.debugLineNum = 13;BA.debugLine="Public lowerAlpha As Boolean";
_loweralpha = false;
 //BA.debugLineNum = 14;BA.debugLine="Public upperAlpha As Boolean";
_upperalpha = false;
 //BA.debugLineNum = 15;BA.debugLine="Public upperRoman As Boolean";
_upperroman = false;
 //BA.debugLineNum = 16;BA.debugLine="Public lowerRoman As Boolean";
_lowerroman = false;
 //BA.debugLineNum = 17;BA.debugLine="Public none As Boolean";
_none = false;
 //BA.debugLineNum = 18;BA.debugLine="Public separator As String";
_separator = "";
 //BA.debugLineNum = 19;BA.debugLine="End Sub";
return "";
}
public anywheresoftware.b4a.objects.collections.Map  _getcontent() throws Exception{
 //BA.debugLineNum = 69;BA.debugLine="Sub getContent As Map";
 //BA.debugLineNum = 70;BA.debugLine="If reversed <> Null Then listX.Put(\"reversed\", re";
if (_reversed!=BA.ObjectToBoolean(__c.Null)) { 
_listx.Put((Object)("reversed"),(Object)(_reversed));};
 //BA.debugLineNum = 71;BA.debugLine="If start <> Null Then listX.Put(\"start\", start)";
if (_start!=(double)(BA.ObjectToNumber(__c.Null))) { 
_listx.Put((Object)("start"),(Object)(_start));};
 //BA.debugLineNum = 72;BA.debugLine="If square <> Null Then listX.Put(\"type\", \"square\"";
if (_square!=BA.ObjectToBoolean(__c.Null)) { 
_listx.Put((Object)("type"),(Object)("square"));};
 //BA.debugLineNum = 73;BA.debugLine="If circle <> Null Then listX.Put(\"type\", \"circle\"";
if (_circle!=BA.ObjectToBoolean(__c.Null)) { 
_listx.Put((Object)("type"),(Object)("circle"));};
 //BA.debugLineNum = 74;BA.debugLine="If color <> Null Then listX.Put(\"color\", color)";
if (_color!= null) { 
_listx.Put((Object)("color"),(Object)(_color));};
 //BA.debugLineNum = 75;BA.debugLine="If markerColor <> Null Then listX.Put(\"markerColo";
if (_markercolor!= null) { 
_listx.Put((Object)("markerColor"),(Object)(_markercolor));};
 //BA.debugLineNum = 76;BA.debugLine="If lowerAlpha <> Null Then listX.Put(\"type\", \"low";
if (_loweralpha!=BA.ObjectToBoolean(__c.Null)) { 
_listx.Put((Object)("type"),(Object)("lower-alpha"));};
 //BA.debugLineNum = 77;BA.debugLine="If upperAlpha <> Null Then listX.Put(\"type\", \"upp";
if (_upperalpha!=BA.ObjectToBoolean(__c.Null)) { 
_listx.Put((Object)("type"),(Object)("upper-alpha"));};
 //BA.debugLineNum = 78;BA.debugLine="If upperRoman <> Null Then listX.Put(\"type\", \"upp";
if (_upperroman!=BA.ObjectToBoolean(__c.Null)) { 
_listx.Put((Object)("type"),(Object)("upper-roman"));};
 //BA.debugLineNum = 79;BA.debugLine="If lowerRoman <> Null Then listX.Put(\"type\", \"low";
if (_lowerroman!=BA.ObjectToBoolean(__c.Null)) { 
_listx.Put((Object)("type"),(Object)("lower-roman"));};
 //BA.debugLineNum = 80;BA.debugLine="If none <> Null Then listX.Put(\"type\", \"none\")";
if (_none!=BA.ObjectToBoolean(__c.Null)) { 
_listx.Put((Object)("type"),(Object)("none"));};
 //BA.debugLineNum = 81;BA.debugLine="If separator <> Null Then listX.Put(\"type\", \"sepa";
if (_separator!= null) { 
_listx.Put((Object)("type"),(Object)("separator"));};
 //BA.debugLineNum = 83;BA.debugLine="listX.Put(lType, items)";
_listx.Put((Object)(_ltype),(Object)(_items.getObject()));
 //BA.debugLineNum = 84;BA.debugLine="style.Include(listX)";
_style._include /*String*/ (_listx);
 //BA.debugLineNum = 85;BA.debugLine="Return listX";
...
innerInitialize(_ba);
 //BA.debugLineNum = 22;BA.debugLine="Public Sub Initialize(typeOf As String) As PDFList";
 //BA.debugLineNum = 23;BA.debugLine="items.Initialize";
_items.Initialize();
 //BA.debugLineNum = 24;BA.debugLine="listX.Initialize";
_listx.Initialize();
 //BA.debugLineNum = 25;BA.debugLine="lType = typeOf";
_ltype = _typeof;
 //BA.debugLineNum = 26;BA.debugLine="style.Initialize";
_style._initialize /*b4j.example.pdfstyle*/ (ba);
 //BA.debugLineNum = 27;BA.debugLine="reversed = Null";
_reversed = BA.ObjectToBoolean(__c.Null);
 //BA.debugLineNum = 28;BA.debugLine="start = Null";
_start = (int)(BA.ObjectToNumber(__c.Null));
 //BA.debugLineNum = 29;BA.debugLine="square = Null";
_square = BA.ObjectToBoolean(__c.Null);
 //BA.debugLineNum = 30;BA.debugLine="circle = Null";
_circle = BA.ObjectToBoolean(__c.Null);
 //BA.debugLineNum = 31;BA.debugLine="color = Null";
_color = BA.ObjectToString(__c.Null);
 //BA.debugLineNum = 32;BA.debugLine="markerColor = Null";
_markercolor = BA.ObjectToString(__c.Null);
 //BA.debugLineNum = 33;BA.debugLine="lowerAlpha = Null";
_loweralpha = BA.ObjectToBoolean(__c.Null);
 //BA.debugLineNum = 34;BA.debugLine="upperAlpha = Null";
_upperalpha = BA.ObjectToBoolean(__c.Null);
 //BA.debugLineNum = 35;BA.debugLine="upperRoman = Null";
_upperroman = BA.ObjectToBoolean(__c.Null);
 //BA.debugLineNum = 36;BA.debugLine="lowerRoman = Null";
_lowerroman = BA.ObjectToBoolean(__c.Null);
 //BA.debugLineNum = 37;BA.debugLine="none = Null";
_none = BA.ObjectToBoolean(__c.Null);
 //BA.debugLineNum = 38;BA.debugLine="separator = Null";
...
public b4j.example.pdflist  _setpagebreakafter() throws Exception{
 //BA.debugLineNum = 63;BA.debugLine="Sub SetPageBreakAfter As PDFList";
 //BA.debugLineNum = 64;BA.debugLine="listX.Put(\"pageBreak\", \"after\")";
...
public b4j.example.pdflist  _setpagebreakbefore() throws Exception{
 //BA.debugLineNum = 57;BA.debugLine="Sub SetPageBreakBefore As PDFList";
 //BA.debugLineNum = 58;BA.debugLine="listX.Put(\"pageBreak\", \"before\")";
