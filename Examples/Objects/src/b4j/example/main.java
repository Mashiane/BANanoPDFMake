...
_banano.Build(_publish);
 //BA.debugLineNum = 29;BA.debugLine="BP.OpenLog(File.DirApp, \"log.txt\")";
...
public static String  _banano_ready() throws Exception{
 ...
 //BA.debugLineNum = 47;BA.debugLine="pgIndex.Init";
...
_banano = new com.ab.banano.BANano();
 //BA.debugLineNum = 7;BA.debugLine="Public AppName As String = \"demo\"";
_appname = "demo";
