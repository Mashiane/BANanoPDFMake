...
public b4j.example.pdfview  _setheight(int _h) throws Exception{
 //BA.debugLineNum = 28;BA.debugLine="Sub SetHeight(h As Int) As PDFView";
...
public b4j.example.pdfview  _sethref(String _shref) throws Exception{
 //BA.debugLineNum = 34;BA.debugLine="Sub SetHREF(shref As String) As PDFView";
...
public b4j.example.pdfview  _setwidth(int _w) throws Exception{
 //BA.debugLineNum = 22;BA.debugLine="Sub SetWidth(w As Int) As PDFView";
