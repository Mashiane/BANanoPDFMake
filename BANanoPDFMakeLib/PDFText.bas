...
'set style
Sub SetStyle(styleNamex As String) As PDFText
	If styleNamex = "" Then Return Me
	style.AddStyle(styleNamex)
	Return Me
End Sub

'set the width
Sub SetStyleWidth(sWidth As String) As PDFText
	style.width = sWidth
	Return Me
End Sub
...
Sub getContent As Map
	...
	If width <> Null Then contentInt.Put("width", width)
	If styleName <> Null Then contentInt.Put("style", styleName)
