...
#DesignerProperty: Key: Colspan, DisplayName: Colspan, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: Rowspan, DisplayName: Rowspan, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: TagName, DisplayName: TagName, FieldType: String, DefaultValue: div , Description: , List: div|p|span|br|b|strong|i|em|s|ul|ol|li|hr|table|thead|tbody|tfoot|tr|th|td|h1|h2|h3|h4|h5|h6|a|u
...
Private mColspan As String = ""
Private mRowspan As String = ""
...
mColspan = Props.Get("Colspan")
mRowspan = Props.Get("Rowspan")
...
AddAttr("colspan", mColspan)
AddAttr("rowspan", mRowspan)
...
public Sub setColspan(varColspan As String)
AddAttr("colspan", varColspan)
mColspan = varColspan
End Sub

public Sub getColspan() As String
Return mColspan
End Sub

public Sub setRowspan(varRowspan As String)
AddAttr("rowspan", varRowspan)
mRowspan = varRowspan
End Sub

public Sub getRowspan() As String
Return mRowspan
End Sub
