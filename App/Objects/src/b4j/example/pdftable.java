...
public b4j.example.pdftable  _addcolumn(String _colname,Object _colwidth,Object _colheight) throws Exception{
 //BA.debugLineNum = 68;BA.debugLine="Sub AddColumn(colName As String, colWidth As Objec";
 //BA.debugLineNum = 69;BA.debugLine="hdr.Add(colName)";
_hdr.Add((Object)(_colname));
 //BA.debugLineNum = 70;BA.debugLine="If colWidth <> Null Then widths.Add(colWidth)";
if (_colwidth!= null) { 
_widths.Add(_colwidth);};
 //BA.debugLineNum = 71;BA.debugLine="If colHeight <> Null Then heights.Add(colHeight)";
if (_colheight!= null) { 
...
public b4j.example.pdftable  _addrow(anywheresoftware.b4a.objects.collections.List _rowdata) throws Exception{
 //BA.debugLineNum = 76;BA.debugLine="Sub AddRow(rowData As List) As PDFTable";
 //BA.debugLineNum = 77;BA.debugLine="rows.Add(rowData)";
...
public b4j.example.pdftable  _addrow1(b4j.example.pdfrow _row) throws Exception{
 //BA.debugLineNum = 82;BA.debugLine="Sub AddRow1(row As PDFRow) As PDFTable";
 //BA.debugLineNum = 83;BA.debugLine="rows.Add(row.Content)";
...
_options = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 3;BA.debugLine="Public layout As String";
_layout = "";
 //BA.debugLineNum = 4;BA.debugLine="Public lightHorizontalLines As Boolean";
_lighthorizontallines = false;
 //BA.debugLineNum = 5;BA.debugLine="Public noBorders As Boolean";
_noborders = false;
 //BA.debugLineNum = 6;BA.debugLine="Public headerLineOnly As Boolean";
_headerlineonly = false;
 //BA.debugLineNum = 7;BA.debugLine="Public headerRows As Int";
_headerrows = 0;
 //BA.debugLineNum = 8;BA.debugLine="Private table As Map";
_table = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 9;BA.debugLine="Private widths As List";
_widths = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 10;BA.debugLine="Private heights As List";
_heights = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 11;BA.debugLine="Private hdr As List";
_hdr = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 12;BA.debugLine="Private body As List";
_body = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 13;BA.debugLine="Private rows As List";
_rows = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 14;BA.debugLine="Public style As PDFStyle";
...
anywheresoftware.b4a.objects.collections.List _lst = null;
 //BA.debugLineNum = 88;BA.debugLine="Sub getContent As Map";
 //BA.debugLineNum = 89;BA.debugLine="If lightHorizontalLines <> Null Then options.Put(";
if (_lighthorizontallines!=BA.ObjectToBoolean(__c.Null)) { 
_options.Put((Object)("layout"),(Object)("lightHorizontalLines"));};
 //BA.debugLineNum = 90;BA.debugLine="If noBorders <> Null Then options.Put(\"layout\", \"";
if (_noborders!=BA.ObjectToBoolean(__c.Null)) { 
_options.Put((Object)("layout"),(Object)("noBorders"));};
 //BA.debugLineNum = 91;BA.debugLine="If headerLineOnly <> Null Then options.Put(\"layou";
if (_headerlineonly!=BA.ObjectToBoolean(__c.Null)) { 
_options.Put((Object)("layout"),(Object)("headerLineOnly"));};
 //BA.debugLineNum = 93;BA.debugLine="If headerRows <> Null Then table.Put(\"headerRows\"";
if (_headerrows!=(double)(BA.ObjectToNumber(__c.Null))) { 
_table.Put((Object)("headerRows"),(Object)(_headerrows));};
 //BA.debugLineNum = 94;BA.debugLine="If widths.Size > 0 Then table.Put(\"widths\", width";
if (_widths.getSize()>0) { 
_table.Put((Object)("widths"),(Object)(_widths.getObject()));};
 //BA.debugLineNum = 95;BA.debugLine="If heights.Size > 0 Then table.Put(\"heights\", hei";
if (_heights.getSize()>0) { 
_table.Put((Object)("heights"),(Object)(_heights.getObject()));};
 //BA.debugLineNum = 97;BA.debugLine="If hdr.Size > 0 Then body.Add(hdr)";
if (_hdr.getSize()>0) { 
_body.Add((Object)(_hdr.getObject()));};
 //BA.debugLineNum = 98;BA.debugLine="For Each lst As List In rows";
...
_lst.setObject((java.util.List)(group8.Get(index8)));
 //BA.debugLineNum = 99;BA.debugLine="body.Add(lst)";
_body.Add((Object)(_lst.getObject()));
 }
};
 //BA.debugLineNum = 101;BA.debugLine="table.Put(\"body\", body)";
_table.Put((Object)("body"),(Object)(_body.getObject()));
 //BA.debugLineNum = 102;BA.debugLine="options.Put(\"table\", table)";
_options.Put((Object)("table"),(Object)(_table.getObject()));
 //BA.debugLineNum = 103;BA.debugLine="style.Include(options)";
_style._include /*String*/ (_options);
 //BA.debugLineNum = 104;BA.debugLine="Return options";
...
innerInitialize(_ba);
 //BA.debugLineNum = 18;BA.debugLine="Public Sub Initialize As PDFTable";
 //BA.debugLineNum = 19;BA.debugLine="options.Initialize";
_options.Initialize();
 //BA.debugLineNum = 20;BA.debugLine="lightHorizontalLines = Null";
_lighthorizontallines = BA.ObjectToBoolean(__c.Null);
 //BA.debugLineNum = 21;BA.debugLine="headerLineOnly = Null";
_headerlineonly = BA.ObjectToBoolean(__c.Null);
 //BA.debugLineNum = 22;BA.debugLine="noBorders = Null";
_noborders = BA.ObjectToBoolean(__c.Null);
 //BA.debugLineNum = 23;BA.debugLine="headerRows = Null";
_headerrows = (int)(BA.ObjectToNumber(__c.Null));
 //BA.debugLineNum = 24;BA.debugLine="table.Initialize";
_table.Initialize();
 //BA.debugLineNum = 25;BA.debugLine="widths.Initialize";
_widths.Initialize();
 //BA.debugLineNum = 26;BA.debugLine="hdr.Initialize";
_hdr.Initialize();
 //BA.debugLineNum = 27;BA.debugLine="body.Initialize";
_body.Initialize();
 //BA.debugLineNum = 28;BA.debugLine="rows.Initialize";
_rows.Initialize();
 //BA.debugLineNum = 29;BA.debugLine="style.Initialize";
...
anywheresoftware.b4a.objects.collections.Map _opt = null;
 //BA.debugLineNum = 34;BA.debugLine="Sub SetAbsolutePosition(x As Int, y As Int) As PDF";
 //BA.debugLineNum = 35;BA.debugLine="Dim opt As Map = CreateMap()";
_opt = new anywheresoftware.b4a.objects.collections.Map();
_opt = __c.createMap(new Object[] {});
 //BA.debugLineNum = 36;BA.debugLine="opt.Put(\"x\", x)";
_opt.Put((Object)("x"),(Object)(_x));
 //BA.debugLineNum = 37;BA.debugLine="opt.Put(\"y\", y)";
_opt.Put((Object)("y"),(Object)(_y));
 //BA.debugLineNum = 38;BA.debugLine="options.Put(\"absolutePosition\", opt)";
...
String _k = "";
 //BA.debugLineNum = 60;BA.debugLine="Sub SetColumnNames(names As List) As PDFTable";
 //BA.debugLineNum = 61;BA.debugLine="For Each k As String In names";
{
...
_k = BA.ObjectToString(group1.Get(index1));
 //BA.debugLineNum = 62;BA.debugLine="hdr.Add(k)";
_hdr.Add((Object)(_k));
 }
};
...
String _k = "";
 //BA.debugLineNum = 52;BA.debugLine="Sub SetHeights(h As List) As PDFTable";
 //BA.debugLineNum = 53;BA.debugLine="For Each k As String In h";
{
...
for (; index1 < groupLen1;index1++){
_k = BA.ObjectToString(group1.Get(index1));
 //BA.debugLineNum = 54;BA.debugLine="heights.Add(k)";
...
String _k = "";
 //BA.debugLineNum = 44;BA.debugLine="Sub SetWidths(w As List) As PDFTable";
 //BA.debugLineNum = 45;BA.debugLine="For Each k As String In w";
{
...
for (; index1 < groupLen1;index1++){
_k = BA.ObjectToString(group1.Get(index1));
 //BA.debugLineNum = 46;BA.debugLine="widths.Add(k)";
