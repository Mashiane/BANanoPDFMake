...
public b4j.example.pdfparagraphs  _addstring(String _txt) throws Exception{
 //BA.debugLineNum = 31;BA.debugLine="Sub AddString(txt As String) As PDFParagraphs";
 //BA.debugLineNum = 32;BA.debugLine="contents.Add(txt)";
...
public b4j.example.pdfparagraphs  _addtext(b4j.example.pdftext _txt) throws Exception{
 //BA.debugLineNum = 25;BA.debugLine="Sub AddText(txt As PDFText) As PDFParagraphs";
 //BA.debugLineNum = 26;BA.debugLine="contents.Add(txt.Content)";
...
public anywheresoftware.b4a.objects.collections.Map  _getcontent() throws Exception{
 //BA.debugLineNum = 37;BA.debugLine="Sub getContent As Map";
 //BA.debugLineNum = 38;BA.debugLine="contentInt.Put(\"text\", contents)";
_contentint.Put((Object)("text"),(Object)(_contents.getObject()));
 //BA.debugLineNum = 39;BA.debugLine="style.Include(contentInt)";
_style._include /*String*/ (_contentint);
 //BA.debugLineNum = 40;BA.debugLine="Return contentInt";
...
innerInitialize(_ba);
 //BA.debugLineNum = 8;BA.debugLine="Public Sub Initialize As PDFParagraphs";
...
anywheresoftware.b4a.objects.collections.Map _opt = null;
 //BA.debugLineNum = 16;BA.debugLine="Sub SetAbsolutePosition(x As Int, y As Int) As PDF";
 //BA.debugLineNum = 17;BA.debugLine="Dim opt As Map = CreateMap()";
_opt = new anywheresoftware.b4a.objects.collections.Map();
_opt = __c.createMap(new Object[] {});
 //BA.debugLineNum = 18;BA.debugLine="opt.Put(\"x\", x)";
_opt.Put((Object)("x"),(Object)(_x));
 //BA.debugLineNum = 19;BA.debugLine="opt.Put(\"y\", y)";
_opt.Put((Object)("y"),(Object)(_y));
 //BA.debugLineNum = 20;BA.debugLine="contentInt.Put(\"absolutePosition\", opt)";
